...
export default function AccountsPage() {
        ...
        try {
          ...
          for (const client of clients) {
            ...
            if (client.id.startsWith("client")) {
              console.log(`Skipping API fetch for mock client ID: ${client.id}`);
              continue;
            }
  ...
  const filteredAccounts = accounts.filter((account) => {
    ...
    const matchesStatus = accountStatusFilter ? account.accountStatus === accountStatusFilter : true;
  ...
  const accountStatuses = [...new Set(accounts.map(account => account.accountStatus))];
  ...
  return (
    <div className="flex flex-col space-y-6 p-8">
      ...
      <div className="grid gap-6">
        ...
        <DashboardCard title="Account List" className="border-l-4 border-l-slate-700 col-span-2">
                    ...
                    {filteredAccounts.map((account) => (
                      ...
                      >
                        <div className="col-span-3">
                          <p className="font-medium">{getClientName(account.clientId)}</p>
                          <p className="text-xs text-slate-500">ID: {account.clientId}</p>
                        </div>
                        ...
                        <div className="col-span-2">{account.initialDeposit} {account.currency}</div>
